        ...
        {isOpen && (
          <Dialog.Portal forceMount>
            ...
            <Dialog.Content asChild forceMount>
              <motion.div
                className="fixed inset-x-3 top-1/2 z-[90] mx-auto max-w-lg -translate-y-1/2 rounded-[24px] bg-[var(--background)] p-6 shadow-2xl sm:p-7"
              ...
              >
                ...
                <div className="mt-6 grid gap-4">
                  <div className="flex items-start justify-between gap-4 rounded-2xl border border-[var(--border)] p-4">
                    <div>
                    ...
                    <Checkbox.Root
                      checked
                      disabled
                      className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-md border border-[var(--border)] bg-[var(--accent-soft)]"
                  ...
                  <div className="flex items-start justify-between gap-4 rounded-2xl border border-[var(--border)] p-4">
                    ...
                    <Checkbox.Root
                      ...
                      className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-md border border-[var(--border)] bg-white data-[state=checked]:bg-[var(--accent-soft)]"
